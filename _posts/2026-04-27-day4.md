...
Final update: Page is looking as good as I can get it with the limitations I set for myself. It was pretty tough, especially not being able to use positioning to get the index link on the right hand side and having to figure out an alternate solution to getting it to display where I wanted it without just breaking on page resize, but I'm actually really happy with how it came out. I do wish I had overflow in my toolbox though, so I could make the box scroll instead of the entire page.
